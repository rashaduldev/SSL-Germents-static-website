...
const Md = () => {
  ...
  <div>
    <Nav isVisible={true}/>
          <div className="container mx-auto my-8 bg-white border border-gray-300 rounded-lg shadow-lg mt-36">
      {/* Top Border */}
      ...
      <div className="p-8 px-10">
       ...
       <div className="">
          ...
          <h1 className="text-lg font-bold text-gray-800 md:text-4xl">Stylorium Sourcing Ltd.</h1>
          </div>
          <h2 className="my-4 text-lg font-bold md:text-4xl">Message from the Managing Director</h2>
                
                {/* Description */}
                <p className="mb-6 leading-10 tracking-normal text-gray-700 md:text-2xl">
                Dear Patrons, Shareholders and Valued Customers:
                </p>
                <p className="leading-10 tracking-normal text-gray-700 md:text-2xl">
                It is a great pleasure that I welcome you to the <b className="font-bold logo-color">STYLORIUM SOURCING LTD.</b>
                </p>
        </div>
      {/* Right Image */}
      <div className="w-[20%]">
        <img src={mdphoto} alt="CEO" className="object-cover w-20 h-20 rounded-lg shadow-md md:w-56 md:h-56" /> {/* Replace with actual image path */}
        </div>
       </div>
