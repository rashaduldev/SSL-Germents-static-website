    ...
    <Nav isVisible={true}/>
      ...
      <div className="p-8 px-10">
       ...
       <div className="">
          ...
          <h2 className="text-lg md:text-4xl font-bold my-4">Message from the Managing Director</h2>
      ...
      {/* Right Image */}
      <div className="w-[20%]">
        <img src={mdphoto} alt="CEO" className="md:w-56 md:h-56 w-20 h-20 object-cover rounded-lg shadow-md" /> {/* Replace with actual image path */}
        </div>
       </div>
          ...
          <div>
            <div className="md:text-2xl space-x-9 tracking-normal leading-10">
